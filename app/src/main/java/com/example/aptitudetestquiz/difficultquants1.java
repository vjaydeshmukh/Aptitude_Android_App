...
public class difficultquants1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList=dbHelper.getQuestions("difficult","quants");
        ...
        submit_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!answered) {
                    ...
                    {
                        Toast.makeText(difficultquants1.this, "Please answer the question", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
