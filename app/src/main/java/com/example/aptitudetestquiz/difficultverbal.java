...
public class difficultverbal extends AppCompatActivity {
    ...
    private void startQuiz() {
        ...
        Intent intent = new Intent(difficultverbal.this, difficultverbal1.class);
        startActivity(intent);
    }
    public void clickback(View view)
    {
        Intent intent1=new Intent(difficultverbal.this,level3.class);
